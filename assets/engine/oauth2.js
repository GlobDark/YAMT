...
<body>
  ...
  <div class="container">
    <div class="sucess">
      <img class="img" src="https://cdn.discordapp.com/attachments/1049349877013954570/1049352069204676699/success.png">
      <h1>successfully logged in</h1>
    </div>
    <div class="text">
      <h3>You will be redirected to your environment</h3>
    </div>
  </div>
      ...
      if (userinfo.verified == true) {
        ...
        if ((newsettings.api.client.oauth2.ip["duplicate check"] == true) && ip !== '127.0.0.1') {
          ...
          if (ipuser && ipuser !== userinfo.id) {
            renderFile(
              `./Theme/${newsettings.defaulttheme}/Errors/AltDetected.ejs`,
              {
